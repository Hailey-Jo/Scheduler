...
<!-- 상단 메뉴바 -->
	...
	<!-- 하단 -->
		<!-- 좌측 서브 메뉴 -->
		<div align="center">
			<button type="button" class="btn btn-info" style="width: 260px" onclick = "location.href = '../schedule/addschedule.jsp' ">스케줄 검색</button>
		</div>	
	...
	<table style= "padding: 10px; text-align: center">
		<col width="130"><col width="230"><col width="280"><col width="330"><col width="60">
		<tr class="phonetitle" >
