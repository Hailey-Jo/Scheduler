...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjUzMDEzNjY1OjNjODZjYTUzOTI4MTk1NTU1MWE1YTNjMjBmNTM4Mzg5NWIxMTRmZjhjN2MzMjU5YzEwNjlmNDcxYTNjYTIxOTg=--656886131c71766459f917064ce32feab136d09f">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="D3BC:90FC:A2B1D0:F3028F:5A9FC35A" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="D3BC:90FC:A2B1D0:F3028F:5A9FC35A" name="octolytics-dimension-request_id" /><meta content="sea" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="33578094" name="octolytics-actor-id" /><meta content="Hailey-Jo" name="octolytics-actor-login" /><meta content="ef413d1fafccf585c26806962f287a464c294f2112acbad73f2331bd1c54a46c" name="octolytics-actor-hash" />
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="Hailey-Jo">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="NGNjNTNkZjIxMmJiNmQwYzUwY2IxYzc4MTFjNWZkNDI5MTA0ZjNhOTMwOGI4NzZlY2JkNDY1ODM0NTgyMjcwMHx7InJlbW90ZV9hZGRyZXNzIjoiMTIxLjY2LjI1Mi4xNTYiLCJyZXF1ZXN0X2lkIjoiRDNCQzo5MEZDOkEyQjFEMDpGMzAyOEY6NUE5RkMzNUEiLCJ0aW1lc3RhbXAiOjE1MjA0MTk2NzUsImhvc3QiOiJnaXRodWIuY29tIn0=">
  ...
  <meta name="html-safe-nonce" content="214f1b35c473b39ead88ac1e4cbe70d0bff504c9">
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-channel="notification-changed:33578094" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@Hailey-Jo" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/33578094?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">Hailey-Jo</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/Hailey-Jo" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/Hailey-Jo?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="uUe5AOMKQxGeytvULlwuzasW8FDb3nWhG21g6mbvvUWtK7fT8hh/jHiX2iPYIYDBDF0X78bEzMIhSanj6LuVPg==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="9xJQTUOCc1WkKw7dUMzPZ1pTBDMVsQVeefj+pewFQw7jfl6eUpBPyEJ2DyqmsWFr/RjjjAirvD1D3DesYlFrdQ==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ffVQgKBlFgCAG0bm1j89cnih9RSPBY4pRyoCY+vb/XSym0zRqK7AZi9N71oUtHahtAGxNWfgBU0gBwRlzy2qpA==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="1092277" />
        ...
        <div class="select-menu js-menu-container js-select-menu">
          ...
          <a class="social-count js-social-count"
            ...
            aria-label="502 users are watching this repository">
            502
          </a>
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="KFsaaUE6KGUeVFmrIluRsl4fGDnAnwwM2FgxVMhVOvKvS+AscZUrofF3Tl69g+1zO+fHaI4hpFKQOAMmpFcjLQ==" /></div>
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/douglascrockford/JSON-js/stargazers"
           aria-label="7295 users starred this repository">
          7,295
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="dkrKgbIDxTTZL/qoln5wdnOo1nZmTRNBCwup5V6MV4PSPRJQvKOkI2IzxafSdZoo9FsGBfOqiwtzqBrWveaUCQ==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Skpl4PIDO+Jsdwngi95FsGeMcMVvx1zod5tOtdMFpCojzWHkBvpm5aMIyfZqRswXgyXXf8ePuHFn5vGAMu019w==" /></div>
            <button
                type="submit"
    ...
    <a href="/douglascrockford/JSON-js/network" class="social-count"
       aria-label="4154 users forked this repository">
      4,154
    </a>
  </li>
</ul>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/douglascrockford/JSON-js/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls checks /douglascrockford/JSON-js/pulls" itemprop="url">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <!-- blob contrib key: blob_contributors:v21:9c481c2eefdfba8fd26786271d5a0d8d -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/douglascrockford/JSON-js" data-pjax="true"><span>JSON-js</span></a></span></span><span class="separator">/</span><strong class="final-path">json2.js</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      ...
      <div>
        <img alt="@douglascrockford" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/262641?s=40&amp;v=4" width="20" />
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@douglascrockford" height="24" src="https://avatars2.githubusercontent.com/u/262641?s=48&amp;v=4" width="24" />
    ...
    <div class="BtnGroup">
      ...
      <a href="/douglascrockford/JSON-js/commits/master/json2.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/edit/master/json2.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ZGJcI1LyHxw4A1NL8nrfosV4gHr121R28UoWwfj4kPdmOgKkxH99SugxgpsPH0+b2R//OS9hLyeI/xlWMsHNPQ==" /></div>
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/douglascrockford/JSON-js/delete/master/json2.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="ncScPo6wvaxcOwLoesKZJ+ouNgmIUX1BMb6CyXSXwwdPP1sw23mgEEMd13aM/ZR/2kUe0V4u5Ta6Z2W+SvWqQA==" /></div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.31880s from unicorn-3935599442-7mcq5">GitHub</span>, Inc.</li>
