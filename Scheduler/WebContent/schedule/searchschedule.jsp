...
%>
 <%
 	...
 	List<ScheduleDTO> searchlist = dao.searchSchedule(searchtitle, id);
 %>
...
<div class="container" id="calListBody">
        <div class="table-wrapper" style="width: 878px">
            ...
            <table id="example" class="table table-striped table-hover" cellspacing="0" width="100%">
                <col width="10%"><col width="20%"><col width="20%"><col width="50%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>시작날짜</th>						
                ...
                <tbody id="exampleBody">
                	...
                	for(int i=0; i<searchlist.size(); i++){
                		...
                		<tr>
	                        <td><%=i+1 %></td>
	                        <td><%=searchlist.get(i).getStartDate().substring(0, 10) %></td>
	                        <td><%=searchlist.get(i).getEndDate().substring(0, 10) %></td>
	                        <td><%=searchlist.get(i).getTitle() %></td>
                        </tr>
                	<%
                	}
                	%>
